...
export const metadata: Metadata = {
  ...
  description:
    "Convert between Standard, Lahori, and Multani Marla. Free Pakistan land area calculator. Standard Marla (272.25 sq ft), Lahori (225 sq ft), Multani (270 sq ft).",
  keywords: [
    "marla calculator",
    "Pakistan land",
    "Lahori marla",
  ...
  openGraph: {
    title: "DMC – Desi Marla Calculator | Pakistan Land Area Converter",
    description:
      "Convert between Standard, Lahori, and Multani Marla. Free Pakistan land area calculator.",
    type: "website",
  },
  twitter: {
    card: "summary_large_image",
    title: "DMC – Desi Marla Calculator",
    description: "Convert between Standard, Lahori, and Multani Marla.",
  },
  robots: "index, follow",
